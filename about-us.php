            ...
            <div class="row align-items-center">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="dpmt_right">
                        <h1>Over 20 Courses from 5 Platform</h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_instructor">
                        <div class="author">
                            <img src="img/instructors/ins1.png" alt="">
                        </div>
                        <div class="author_decs">
                            <h4>Olajide Oladapo Ayo</h4>
                            <p class="profession">Sr. Faculty Javascript</p>
                            <p>If you are looking at his smile, you may not be able to consetrate.</p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_instructor">
                        <div class="author">
                            <img src="img/instructors/ins2.png" alt="">
                        </div>
                        <div class="author_decs">
                            <h4>Olorunfemi Possible</h4>
                            <p class="profession">Sr. Faculty Graphics</p>
                            <p>If you are looking at his gentleness, you may be loss.</p>
                            <div class="social_icons">
                                <a href="#"><i class="fa fa-facebook"></i></a>
                                <a href="#"><i class="fa fa-twitter"></i></a>
                                <a href="#"><i class="fa fa-whatsapp"></i></a>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_instructor">
                        ...
                        <div class="author_decs">
                            <h4>Owoputi Omokehinde Samuel</h4>
                            <p class="profession">Sr. Faculty html and Css</p>
                            <p>few words is enough for the wise</p>
                            <div class="social_icons">
                                <a href="#"><i class="fa fa-facebook"></i></a>
                                <a href="#"><i class="fa fa-twitter"></i></a>
                                <a href="#"><i class="fa fa-whatsapp"></i></a>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_instructor">
                        ...
                        <div class="author_decs">
                            <h4>Eunice Kemisola Beauty</h4>
                            <p class="profession">Sr. Faculty Data Science</p>
                            <p>If you are looking at her beauty, you may not be able to focus.</p>
                            <div class="social_icons">
                                <a href="#"><i class="fa fa-facebook"></i></a>
                                <a href="#"><i class="fa fa-twitter"></i></a>
                                <a href="#"><i class="fa fa-whatsapp"></i></a>
