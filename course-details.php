                    ...
                    <div class="col-lg-6">
                        <div class="banner_content text-center">
                            ...
                            <div class="page_link">
                                ...
                                <a href="course-details.php">Details</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <ul>
                        <li>
                            <a class="justify-content-between d-flex" href="#">
                                <p>Trainer’s Name</p>
                                <span class="or">Owoputi Omokehinde</span>
                            </a>
                        </li>
                        <li>
                            <a class="justify-content-between d-flex" href="#">
                            ...
                            <div class="comment-list">
                                <div class="single-comment single-reviews justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        ...
                                        <div class="desc">
                                            <h5><a href="#">Olajide Oladapo Ayo</a>
                                                <div class="star">
                            ...
                            <div class="comment-list">
                                <div class="single-comment single-reviews justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        ...
                                        <div class="desc">
                                            <h5><a href="#">Olorunfemi Possible</a>
                                                <div class="star">
                                                    <span class="fa fa-star checked"></span>
                                                    <span class="fa fa-star checked"></span>
                                                    <span class="fa fa-star checked"></span>
