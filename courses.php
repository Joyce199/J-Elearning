        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="single_course">
                        <div class="course_head overlay">
                            ...
                            <div class="authr_meta">
                                ...
                                <span>Olajide Oladapo Ayomide</span>
                            </div>
                        </div>
                            ...
                            <div class="course_meta d-flex justify-content-between">
                                <div>
                                    <span class="meta_info">
                                        <a href="#"><i class="lnr lnr-user"></i>55</a>
                                    </span>
                                    <span class="meta_info">
                                        <a href="#">
                                            <i class="lnr lnr-bubble"></i>6
                                        </a>
                                    </span>
                                </div>
                                <div>
                        ...
                        <div class="course_content">
                            ...
                            <div class="course_meta d-flex justify-content-between">
                                <div>
                                    <span class="meta_info">
                                        <a href="#">
                                            <i class="lnr lnr-user"></i>35
                                        </a>
                                    </span>
                                    <span class="meta_info"><a href="#">
                                            <i class="lnr lnr-bubble"></i>5
                                        </a></span>
                                </div>
                                <div>
                                    <span class="price df_color1">#2,500</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single_course">
                        <div class="course_head overlay">
                            <img class="img-fluid w-100" src="img/courses/trainer3.jpg" alt="">
                            <div class="authr_meta">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single_course">
                        <div class="course_head overlay">
                            <img class="img-fluid w-100" src="img/courses/trainer4.png" alt="">
                            <div class="authr_meta">
                        ...
                        <div class="course_content">
                            ...
                            <div class="course_meta d-flex justify-content-between">
                                ...
                                <div>
                                    <span class="price df_color2">#1,500</span>
                                </div>
                            </div>
                        </div>
                    </div>
