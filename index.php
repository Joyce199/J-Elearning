			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6 col-sm-6 col-4 header-top-left">
						<a href="tel:+2348149774052">
							<span class="lnr lnr-phone"></span>
							<span class="text">
								<span class="text">+234814 9774 052</span>
							</span>
						</a>
						<a href="oluwaseyifunmmyjoy1@gmail.com">
							<span class="lnr lnr-envelope"></span>
							<span class="text">
								<span class="text">oluwaseyifunmmyjoy1@gmail.com</span>
							</span>
						</a>
					</div>
					<div class="col-lg-6 col-sm-6 col-8 header-top-right">
						<a href="home.php" class="text-uppercase">Login</a>
                        <a href="sign_up.php" class="text-uppercase">sign up</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="row">
					...
					<div class="single_course">
						<div class="course_head overlay">
							...
							<div class="authr_meta">
								...
								<span>Oladapo Olajide Ayomide</span>
							</div>
						</div>
						<div class="course_content">
							<h4>
								<a href="course-details.php">Learn React js beginners</a>
							</h4>
							...
							<div class="course_meta d-flex justify-content-between">
								<div>
									<span class="meta_info">
										<a href="#"><i class="lnr lnr-user"></i>35</a>
									</span>
									<span class="meta_info">
										<a href="#">
					...
					<div class="single_course">
						<div class="course_head overlay">
							...
							<div class="authr_meta">
								...
								<span>Adebayo Silas</span>
							</div>
						</div>
						<div class="course_content">
							<h4>
								<a href="course-details.php">Learn php beginners</a>
							</h4>
							<p>When television was young, there was a huge popular show based on the still popular fictional character of
								Superman.</p>
							<div class="course_meta d-flex justify-content-between">
								...
								<div>
									<span class="price df_color1">#6,000</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="single_course">
						<div class="course_head overlay">
							<img class="img-fluid w-100" src="img/courses/home-trainer/trainer3.png" alt="">
							<div class="authr_meta">
								<img src="img/courses/home-trainer/author3.png" alt="">
								<span>Olorunfemi Possible</span>
							</div>
						</div>
						<div class="course_content">
							<h4>
								<a href="course-details.html">Learn Graphics beginners</a>
							</h4>
							<p>When television was young, there was a huge popular show based on the still popular fictional character of
								Superman.</p>
							<div class="course_meta d-flex justify-content-between">
				...
				<div class="col-lg-3 col-md-6">
					<div class="single_course">
						<div class="course_head overlay">
							<img class="img-fluid w-100" src="img/courses/home-trainer/trainer4.jpg" alt="">
							<div class="authr_meta">
								<img src="img/courses/home-trainer/author4.jpg" alt="">
								<span>Owoputi Omokehinde</span>
							</div>
						</div>
						<div class="course_content">
							<h4>
								<a href="course-details.html">Learn HTMl/CSS beginners</a>
							</h4>
							<p>When television was young, there was a huge popular show based on the still popular fictional character of
								Superman.</p>
							<div class="course_meta d-flex justify-content-between">
								...
								<div>
									<span class="price df_color2">#20,000</span>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="row align-items-center">
									...
									<div class="col-lg-6 col-md-7">
										<div class="event_details">
											<p>18th March, 2020</p>
											<h4>
												<a href="#">Matriculation of new students</a>
											</h4>
								...
								<div class="row align-items-center">
									...
									<div class="col-lg-5 col-md-7">
										<div class="event_details">
											<p>21st March, 2020</p>
											<h4>
												<a href="#">maiden convocation</a>
											</h4>
											<p>Award of first degrees and presentation of prizes</p>
										</div>
									</div>
								</div>
							</div>
	...
	<footer class="footer-area section_gap">
		<div class="container">
			...
			<div class="row footer-bottom d-flex justify-content-between">
				<p class="col-lg-8 col-sm-12 footer-text m-0 text-white">Copyright © 2018 All rights reserved</p>
